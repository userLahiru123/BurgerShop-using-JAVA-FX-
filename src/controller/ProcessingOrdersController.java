...
public class ProcessingOrdersController implements Initializable {
    ...
    public TableView tblProcessingOrders;
    ...
    public void loadTable(){
        ...
        deliveredList = controller.viewOrders(Burger.PREPARING);
        tblProcessingOrders.setItems(deliveredList);
    }
}
